...
const { default: makeWASocket, isJidGroup, DisconnectReason, commandRegistry, delay, makeCacheableSignalKeyStore, fetchLatestBaileysVersion, useMultiFileAuthState, makeInMemoryStore, jidDecode, getContentType } = require("@whiskeysockets/baileys");
...
const { getSettings } = require("./lib/Adams");
