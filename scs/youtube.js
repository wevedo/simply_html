...
// Validate that the necessary credentials are set
...
adams({
  ...
  // Send the final response with a larger thumbnail
  await zk.sendMessage(dest, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        renderLargerThumbnail: true, // Fullscreen thumbnail
...
// Song Command (Similar to Play Command)
adams({
  nomCom: "song",
  categorie: "Download",
  reaction: "🎧"
