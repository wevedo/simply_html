  ...
  async (dest, zk, commandOptions) => {
    ...
    try {
      ...
      const countingInterval = setInterval(async () => {
        ...
        countingMessage = await zk.sendMessage(
          dest,
      ...
      // Delete counting messages (if supported by bot)
      if (countingMessage?.key) {
        await zk.sendMessage(dest, { delete: countingMessage.key });
      }
